  ...
  return (
    <footer className="py-8 px-4 mt-16 text-center text-muted-foreground text-sm border-t border-border font-serif">
      <div className="max-w-3xl mx-auto">
        <p className="mb-4">
          $MKS é mais que uma stablecoin. É uma fundação para a nova economia digital — descentralizada, transparente e controlada por código.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Contato: <a href="mailto:markcash.eth@ethermail.io" className="text-accent font-semibold hover:underline">markcash.eth@ethermail.io</a>
        </p>
